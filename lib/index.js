...
const increment = () => {
  ...
  if (helpArg) {
    ...
    console.log(' -o, --output', ' output format, one of "json","xml","text" (default is text) ')  
    console.log(
      ' -p, --path',
  ...
  const output =  argv['o'] || argv['output'] || 'text';
  ...
  if ( output === 'json' ) {
  	...
  	console.log('<newVersion>'+newVersion+'</newVersion>');
  } else {
